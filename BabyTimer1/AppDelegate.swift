...
//        Mixpanel.sharedInstance(withToken: "590e9476af14a8596b1b8b207a21f56b")
    ...
    func handleShortcut(shortcutItem: UIApplicationShortcutItem) -> Bool {
        ...
        if shortcutItem.type == (Bundle.main.bundleIdentifier!+".FiveMinutes") {
            ...
            mainViewController.timerAction(min: 5)
            succeeded = true
        } else if shortcutItem.type == (Bundle.main.bundleIdentifier!+".FifteenMinutes") {
            print("- Handling \(shortcutItem.type)")
            let mainViewController = self.window!.rootViewController as! MainViewController
            if !mainViewController.brightMoon { mainViewController.updateState() }
            mainViewController.timerAction(min: 15)
            succeeded = true
        }
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = Bundle.main.url(forResource: "BabyTime", withExtension: "momd")!
    ...
    lazy var persistentStoreCoordinator: NSPersistentStoreCoordinator = {
        ...
        let url = self.applicationDocumentsDirectory.appendingPathComponent("BabyTime.sqlite")
